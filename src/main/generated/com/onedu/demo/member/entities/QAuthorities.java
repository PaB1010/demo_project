...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    private static final long serialVersionUID = -1301140415L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAuthorities authorities = new QAuthorities("authorities");

    public final EnumPath<com.onedu.demo.member.contants.Authority> authority = createEnum("authority", com.onedu.demo.member.contants.Authority.class);
